...
class NMTModel(nn.Module):
  ...
  def forward(self, src, tgt, structure, lengths):
...
def build_encoder(opt, embeddings, structure_embeddings):
  ...
  """
  return TransformerEncoder(opt.enc_layers, opt.enc_rnn_size, opt.heads, opt.transformer_ff, opt.dropout, embeddings, structure_embeddings)
